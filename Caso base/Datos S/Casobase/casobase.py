...
seed = 42
HORIZONTE_TOTAL = 52
#Las ventanas del rolling horizon seran de 6 semanas, para que el codigo no sea muy pesado de correr
VENTANA_ROLLING = 6

#Preparar datos de nodos (consumidores y proveedores)
...
consumidores_info['S_ideal'] = 10 * consumidores_info['Demanda_Semanal']
